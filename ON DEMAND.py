...
#PROCESSING
def processingTweet(list_tweet, tweet_id,screen_name):
...
#THREAD DEF
def processBOT(screen_name,tweet_id):
    list_tweet = crawlQRTREP(tweet_id)
    processingTweet(list_tweet, tweet_id,screen_name)
...
if __name__ == "__main__":
    ...
    screen_name = input("Input username:")
    id_twt = input("Input ID Tweet:")
    processBOT(screen_name,id_twt)
